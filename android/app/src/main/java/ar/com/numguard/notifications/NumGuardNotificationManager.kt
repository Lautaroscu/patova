package ar.com.numguard.notifications
...
import ar.com.numguard.MainActivity
import dagger.hilt.android.qualifiers.ApplicationContext
import javax.inject.Inject
import javax.inject.Singleton

@Singleton
class NumGuardNotificationManager @Inject constructor(
    @ApplicationContext private val context: Context
) {
    companion object {
        const val CHANNEL_BLOCKED_ID = "numguard_blocked_calls"
        const val CHANNEL_BLOCKED_NAME = "Llamadas bloqueadas"
        const val CHANNEL_ERROR_ID = "numguard_errors"
    ...
    private fun createChannels() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val blockedChannel = NotificationChannel(
                ...
                description = "Notificaciones de llamadas bloqueadas por NumGuard"
            }
    ...
    fun showBlockedCallNotification(
        ...
        val title = "Llamada bloqueada por NumGuard"
    ...
    fun showVerificationFailedNotification() {
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ERROR_ID)
            ...
            .setContentText("No se pudo verificar la llamada. NumGuard la dejo pasar por seguridad.")
            .setStyle(
                NotificationCompat.BigTextStyle()
                    .bigText("No se pudo verificar la llamada. NumGuard la dejo pasar por seguridad.")
            )
