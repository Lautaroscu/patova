    ...
    Column(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Text(
                    text = if (isConfigured.value) {
                        "Patova esta configurado como app de screening"
                    } else {
                        "Patova NO esta configurado como app de screening"
                    },
                ...
                Text(
                    text = if (isConfigured.value) {
                        "Patova esta activo y filtrara las llamadas entrantes automaticamente."
                    } else {
                        "Sin este permiso, Patova no puede analizar ni bloquear llamadas. " +
        ...
        Button(
            ...
            Text(
                text = if (isConfigured.value) {
                    ...
                    "Activar Patova como app de screening"
                }
            )
        }
        ...
        Text(
            text = "Instrucciones manuales:\n\n" +
                    ...
                    "Identificador de llamadas y spam / Screening de llamadas > Selecciona Patova",
