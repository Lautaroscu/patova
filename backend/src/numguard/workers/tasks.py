...
from numguard.models.enums import FeedbackType, NumberStatus
from numguard.models.feedback_event import FeedbackEvent
from numguard.models.phone_number import PhoneNumber
from numguard.models.report import Report
from numguard.services.cache_service import invalidate_validate_cache
from numguard.services.scoring_service import (
    calculate_spam_score,
    get_reports_last_24h,
    should_auto_block,
)
from numguard.workers.celery_app import app
