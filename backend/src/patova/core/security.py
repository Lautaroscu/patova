...
API_KEY_HEADER = APIKeyHeader(name="X-Patova-Key", auto_error=False)

_RATE_LIMIT_IP_PREFIX = "patova:rate-limit-ip"
_RATE_LIMIT_TOKEN_PREFIX = "patova:rate-limit-token"
